...
{
	public XE_HR_PACKAGE1_RETURNSTRINGPROC_IM GetHydratedStaticXE_HR_PACKAGE1_RETURNSTRINGPROC_IM(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_PACKAGE1_RETURNSTRINGPROC_IM();
		// Input parameters
		retObj.VAR_INPUT = (272779213);
		return retObj;
	}
}
