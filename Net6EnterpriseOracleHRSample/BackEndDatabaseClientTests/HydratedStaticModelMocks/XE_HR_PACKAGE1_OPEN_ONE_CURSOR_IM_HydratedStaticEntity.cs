...
{
	public XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM GetHydratedStaticXE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM();
		// Input parameters
		retObj.N_EMPNO = (385272483);
		return retObj;
	}
}
