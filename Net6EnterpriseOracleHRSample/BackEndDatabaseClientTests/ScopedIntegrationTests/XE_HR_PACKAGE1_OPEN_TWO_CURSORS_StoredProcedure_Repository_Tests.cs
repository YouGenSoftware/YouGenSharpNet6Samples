...
[TestClass()]
public class XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Repository_Tests : ScopedIntegrationStoredProcedureRepositoryTestBase
{
    private Mock<ILogger<XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Repository>>? _logger;
	private IXE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Repository? _repository;
    ...
    {
        base.Init();
        _logger = new Mock<ILogger<XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Repository>>();		
        _repository = new XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Repository(_logger!.Object, _dbConnection!);
