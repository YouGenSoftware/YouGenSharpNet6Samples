...
[TestClass()]
public class XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected IXE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Service");
        _serviceClient = new XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	public async Task StaticCall_XE_HR_PACKAGE1_OPEN_TWO_CURSORS_Test()
	{
		// When
		var retData = await _serviceClient!.Call_XE_HR_PACKAGE1_OPEN_TWO_CURSORSAsync();
		// Then
