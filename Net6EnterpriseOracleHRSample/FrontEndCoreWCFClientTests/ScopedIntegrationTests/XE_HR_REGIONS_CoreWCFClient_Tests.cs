...
[TestClass()]
public class XE_HR_REGIONS_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected IXE_HR_REGIONS_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/XE_HR_REGIONS_Service");
        _serviceClient = new XE_HR_REGIONS_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	...
	{
		// Given
		var input = (XE_HR_REGIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		// When
	...
	{
		// Given
		var input = (XE_HR_REGIONS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_REGIONS_IR();
		// When
		var retData = await _serviceClient!.CreateAsync(input);
		// Then
		Assert.IsTrue(retData != null);
	...
	public async Task GetByREGION_IDDynamicTest()
	{
		...
		var input = (XE_HR_REGIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		// When
		var retData = await _serviceClient!.GetByREGION_IDAsync(input.REGION_ID_IR ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByREGION_IDDynamicTest()
	{
		// Given
		var input = (XE_HR_REGIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		var input2 = (XE_HR_REGIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		// When
		await _serviceClient!.UpdateByREGION_IDAsync(input.REGION_ID_IR ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByREGION_IDStaticTest()
	{
		...
		var input = (XE_HR_REGIONS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_REGIONS_IR();
		// When
		await _serviceClient!.UpdateByREGION_IDAsync(input.REGION_ID_IR ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByREGION_IDDynamicTest()
	{
		...
		var input = (XE_HR_REGIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		// When
		await _serviceClient!.DeleteByREGION_IDAsync(input.REGION_ID_IR ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
