...
[TestClass()]
public class XE_HR_PACKAGE1_RETURNSTRINGPROC_StoredProcedure_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected IXE_HR_PACKAGE1_RETURNSTRINGPROC_StoredProcedure_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/XE_HR_PACKAGE1_RETURNSTRINGPROC_StoredProcedure_Service");
        _serviceClient = new XE_HR_PACKAGE1_RETURNSTRINGPROC_StoredProcedure_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	public async Task StaticCall_XE_HR_PACKAGE1_RETURNSTRINGPROC_Test()
	{
		// Given
		var input = (XE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR();
		// When
		var retData = await _serviceClient!.Call_XE_HR_PACKAGE1_RETURNSTRINGPROCAsync(input);
		// Then
	...
	{
		// Given
		var input = (XE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR();
		// When
		var retData = await _serviceClient!.Call_XE_HR_PACKAGE1_RETURNSTRINGPROCAsync(input);
		// Then
		Assert.IsTrue(retData != null);
