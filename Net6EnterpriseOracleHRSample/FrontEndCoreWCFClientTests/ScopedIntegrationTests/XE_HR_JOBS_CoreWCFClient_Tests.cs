...
[TestClass()]
public class XE_HR_JOBS_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected IXE_HR_JOBS_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/XE_HR_JOBS_Service");
        _serviceClient = new XE_HR_JOBS_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	...
	{
		// Given
		var input = (XE_HR_JOBS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_JOBS_IR();
		// When
	...
	{
		// Given
		var input = (XE_HR_JOBS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_JOBS_IR();
		// When
		var retData = await _serviceClient!.CreateAsync(input);
		// Then
		Assert.IsTrue(retData != null);
	...
	public async Task UpdateByJOB_IDDynamicTest()
	{
		// Given
		var input = (XE_HR_JOBS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_JOBS_IR();
		var input2 = (XE_HR_JOBS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_JOBS_IR();
		// When
