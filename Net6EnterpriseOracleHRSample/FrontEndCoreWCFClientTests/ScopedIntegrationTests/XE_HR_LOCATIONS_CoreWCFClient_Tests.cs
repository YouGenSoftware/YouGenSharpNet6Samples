...
[TestClass()]
public class XE_HR_LOCATIONS_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected IXE_HR_LOCATIONS_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/XE_HR_LOCATIONS_Service");
        _serviceClient = new XE_HR_LOCATIONS_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	...
	{
		// Given
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
	...
	{
		// Given
		var input = (XE_HR_LOCATIONS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_LOCATIONS_IR();
		// When
		var retData = await _serviceClient!.CreateAsync(input);
		// Then
		Assert.IsTrue(retData != null);
	...
	public async Task GetByCITYDynamicTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		var retData = await _serviceClient!.GetByCITYAsync(input.CITY ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task GetByCOUNTRY_IDDynamicTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		var retData = await _serviceClient!.GetByCOUNTRY_IDAsync(input.COUNTRY_ID);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task GetBySTATE_PROVINCEDynamicTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		var retData = await _serviceClient!.GetBySTATE_PROVINCEAsync(input.STATE_PROVINCE);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByCITYDynamicTest()
	{
		// Given
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		var input2 = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.UpdateByCITYAsync(input.CITY ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByCITYStaticTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.UpdateByCITYAsync(input.CITY ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByCOUNTRY_IDDynamicTest()
	{
		...
		var input2 = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.UpdateByCOUNTRY_IDAsync(input.COUNTRY_ID, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByCOUNTRY_IDStaticTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.UpdateByCOUNTRY_IDAsync(input.COUNTRY_ID, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	...
	public async Task UpdateBySTATE_PROVINCEDynamicTest()
	{
		...
		var input2 = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.UpdateBySTATE_PROVINCEAsync(input.STATE_PROVINCE, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateBySTATE_PROVINCEStaticTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_staticIRModels!.GetHydratedStaticXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.UpdateBySTATE_PROVINCEAsync(input.STATE_PROVINCE, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByCITYDynamicTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.DeleteByCITYAsync(input.CITY ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	...
	public async Task DeleteByCOUNTRY_IDDynamicTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.DeleteByCOUNTRY_IDAsync(input.COUNTRY_ID);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	...
	public async Task DeleteBySTATE_PROVINCEDynamicTest()
	{
		...
		var input = (XE_HR_LOCATIONS_IR)(object)_dynamicIRModels!.GetHydratedDynamicXE_HR_LOCATIONS_IR();
		// When
		await _serviceClient!.DeleteBySTATE_PROVINCEAsync(input.STATE_PROVINCE);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
