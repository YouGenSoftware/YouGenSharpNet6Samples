...
[TestClass()]
public class XE_HR_EMP_DETAILS_VIEW_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected IXE_HR_EMP_DETAILS_VIEW_Service? _serviceClient;    
    protected EndpointAddress? _endpointAddress; 
	[TestInitialize()]
    public override void Init()
    {
        base.Init();
        _endpointAddress = new EndpointAddress(_baseAddress! + "/XE_HR_EMP_DETAILS_VIEW_Service");
        _serviceClient = new XE_HR_EMP_DETAILS_VIEW_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
