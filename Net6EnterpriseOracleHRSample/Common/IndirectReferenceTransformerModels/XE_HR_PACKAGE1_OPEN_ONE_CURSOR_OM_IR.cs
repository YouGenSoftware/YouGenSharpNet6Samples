...
/// </summary>
public class XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_IR
{
	public XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_IR() 
	{
	} 
	public IEnumerable<XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR> Query1_Results_IR { get; set; } = null!;
}
