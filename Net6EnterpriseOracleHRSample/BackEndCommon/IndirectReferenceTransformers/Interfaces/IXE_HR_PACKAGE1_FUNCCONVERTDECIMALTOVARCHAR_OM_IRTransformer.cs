...
{
	XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_OM_IR? ToIndirectModel(XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_OM input);
	XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_OM? ToEntity(XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_OM_IR input);
}
