...
{
	XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR? ToIndirectModel(XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1 input);
	XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1? ToEntity(XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR input);
}
