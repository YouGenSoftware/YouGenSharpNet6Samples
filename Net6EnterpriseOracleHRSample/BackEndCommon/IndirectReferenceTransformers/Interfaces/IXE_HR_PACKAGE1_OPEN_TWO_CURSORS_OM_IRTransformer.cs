...
{
	XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_IR? ToIndirectModel(XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM input);
	XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM? ToEntity(XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_IR input);
}
