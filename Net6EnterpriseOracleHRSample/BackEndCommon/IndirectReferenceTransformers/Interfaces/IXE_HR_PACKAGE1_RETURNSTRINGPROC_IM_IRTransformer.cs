...
{
	XE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR? ToIndirectModel(XE_HR_PACKAGE1_RETURNSTRINGPROC_IM input);
	XE_HR_PACKAGE1_RETURNSTRINGPROC_IM? ToEntity(XE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR input);
}
