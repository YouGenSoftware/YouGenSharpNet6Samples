...
{
	XE_HR_PACKAGE1_PARAMOUTCURSORS_OM_Query1_IR? ToIndirectModel(XE_HR_PACKAGE1_PARAMOUTCURSORS_OM_Query1 input);
	XE_HR_PACKAGE1_PARAMOUTCURSORS_OM_Query1? ToEntity(XE_HR_PACKAGE1_PARAMOUTCURSORS_OM_Query1_IR input);
}
