...
{
	XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM_IR? ToIndirectModel(XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM input);
	XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM? ToEntity(XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM_IR input);
}
