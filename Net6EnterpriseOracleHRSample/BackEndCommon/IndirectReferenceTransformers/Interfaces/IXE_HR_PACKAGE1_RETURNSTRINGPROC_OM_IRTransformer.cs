...
{
	XE_HR_PACKAGE1_RETURNSTRINGPROC_OM_IR? ToIndirectModel(XE_HR_PACKAGE1_RETURNSTRINGPROC_OM input);
	XE_HR_PACKAGE1_RETURNSTRINGPROC_OM? ToEntity(XE_HR_PACKAGE1_RETURNSTRINGPROC_OM_IR input);
}
