...
{
	XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_IR? ToIndirectModel(XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM input);
	XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM? ToEntity(XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_IR input);
}
