...
{
	XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM_IR? ToIndirectModel(XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM input);
	XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM? ToEntity(XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM_IR input);
}
