...
{
	XE_HR_REGIONS_IR? ToIndirectModel(XE_HR_REGIONS input, Boolean isSecondaryLookup = false);
	XE_HR_REGIONS? ToEntity(XE_HR_REGIONS_IR input, Boolean isSecondaryLookup = false);
}
