...
{
	XE_HR_PACKAGE1_PARAMOUTCURSORS_OM_IR? ToIndirectModel(XE_HR_PACKAGE1_PARAMOUTCURSORS_OM input);
	XE_HR_PACKAGE1_PARAMOUTCURSORS_OM? ToEntity(XE_HR_PACKAGE1_PARAMOUTCURSORS_OM_IR input);
}
