...
{
	XE_HR_COUNTRIES_IR? ToIndirectModel(XE_HR_COUNTRIES input, Boolean isSecondaryLookup = false);
	XE_HR_COUNTRIES? ToEntity(XE_HR_COUNTRIES_IR input, Boolean isSecondaryLookup = false);
}
