...
{
	XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_Query2_IR? ToIndirectModel(XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_Query2 input);
	XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_Query2? ToEntity(XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_Query2_IR input);
}
