...
{
	XE_HR_DEPARTMENTS_IR? ToIndirectModel(XE_HR_DEPARTMENTS input, Boolean isSecondaryLookup = false);
	XE_HR_DEPARTMENTS? ToEntity(XE_HR_DEPARTMENTS_IR input, Boolean isSecondaryLookup = false);
}
