...
{
	XE_HR_PACKAGE1_PARAMOUTCURSORS_IM_IR? ToIndirectModel(XE_HR_PACKAGE1_PARAMOUTCURSORS_IM input);
	XE_HR_PACKAGE1_PARAMOUTCURSORS_IM? ToEntity(XE_HR_PACKAGE1_PARAMOUTCURSORS_IM_IR input);
}
