...
{
	XE_HR_LOCATIONS_IR? ToIndirectModel(XE_HR_LOCATIONS input, Boolean isSecondaryLookup = false);
	XE_HR_LOCATIONS? ToEntity(XE_HR_LOCATIONS_IR input, Boolean isSecondaryLookup = false);
}
