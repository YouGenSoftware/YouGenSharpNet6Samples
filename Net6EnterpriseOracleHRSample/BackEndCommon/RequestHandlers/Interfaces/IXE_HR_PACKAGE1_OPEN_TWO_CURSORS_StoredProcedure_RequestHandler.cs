...
public interface IXE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_RequestHandler
{
	//Main Handlers
	Task<XE_HR_PACKAGE1_OPEN_TWO_CURSORS_OM_IR?> HandleCall_XE_HR_PACKAGE1_OPEN_TWO_CURSORS();
}
