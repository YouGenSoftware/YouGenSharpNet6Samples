...
public class XE_HR_EMPLOYEES_Controller : ControllerBase
{
	...
	public async Task<XE_HR_EMPLOYEES_IR?> Create([FromBody]XE_HR_EMPLOYEES_IR input)
	{
	...
	public async Task UpdateByFIRST_NAMEAndLAST_NAME(String? fIRST_NAME, String lAST_NAME, [FromBody]XE_HR_EMPLOYEES_IR input)
	{
	...
	public async Task UpdateByDEPARTMENT_ID(String? dEPARTMENT_ID_IR, [FromBody]XE_HR_EMPLOYEES_IR input)
	{
	...
	public async Task UpdateByEMAIL(String eMAIL, [FromBody]XE_HR_EMPLOYEES_IR input)
	{
	...
	public async Task UpdateByEMPLOYEE_ID(String? eMPLOYEE_ID_IR, [FromBody]XE_HR_EMPLOYEES_IR input)
	{
	...
	public async Task UpdateByJOB_ID(String jOB_ID, [FromBody]XE_HR_EMPLOYEES_IR input)
	{
	...
	public async Task UpdateByMANAGER_ID(String? mANAGER_ID_IR, [FromBody]XE_HR_EMPLOYEES_IR input)
	{
