...
[TestClass()]
public class XE_HR_PACKAGE1_PARAMOUTCURSORS_StoredProcedure_HttpClient_Tests : HttpClientTestBase
{
	protected IXE_HR_PACKAGE1_PARAMOUTCURSORS_StoredProcedure_HttpClient? _specificHttpClient;
    ...
    public override void Init()
    {
        ...
        _specificHttpClient = new XE_HR_PACKAGE1_PARAMOUTCURSORS_StoredProcedure_HttpClient(_httpClient!);
    }
	[TestMethod()]
	public async Task StaticCall_XE_HR_PACKAGE1_PARAMOUTCURSORS_Test()
	{
		...
		// When
		var retData = await _specificHttpClient!.Call_XE_HR_PACKAGE1_PARAMOUTCURSORS(input);
		// Then
