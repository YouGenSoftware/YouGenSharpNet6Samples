...
public class Program
{
    public static void Main()
    {
		...
		builder.Services.AddScoped<IDbConnection>(s => new OracleConnection(customAppSettings!.DbConnection!));
		...
		app.MapHub<XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_StoredProcedure_Hub>("XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_StoredProcedure_Hub");
		app.MapHub<XE_HR_PACKAGE1_OPEN_ONE_CURSOR_StoredProcedure_Hub>("XE_HR_PACKAGE1_OPEN_ONE_CURSOR_StoredProcedure_Hub");
		app.MapHub<XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Hub>("XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Hub");
		app.MapHub<XE_HR_PACKAGE1_PARAMOUTCURSORS_StoredProcedure_Hub>("XE_HR_PACKAGE1_PARAMOUTCURSORS_StoredProcedure_Hub");
		app.MapHub<XE_HR_PACKAGE1_RETURNSTRINGPROC_StoredProcedure_Hub>("XE_HR_PACKAGE1_RETURNSTRINGPROC_StoredProcedure_Hub");
