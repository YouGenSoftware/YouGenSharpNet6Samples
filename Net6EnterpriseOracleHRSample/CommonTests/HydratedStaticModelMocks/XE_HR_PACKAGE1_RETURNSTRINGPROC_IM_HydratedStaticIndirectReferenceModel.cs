...
{
	public XE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR GetHydratedStaticXE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_PACKAGE1_RETURNSTRINGPROC_IM_IR();
		// Input parameters
		retObj.VAR_INPUT = (1753642965);
