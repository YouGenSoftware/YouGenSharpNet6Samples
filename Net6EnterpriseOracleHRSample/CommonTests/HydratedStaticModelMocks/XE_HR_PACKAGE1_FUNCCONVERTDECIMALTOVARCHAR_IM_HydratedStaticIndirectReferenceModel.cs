...
{
	public XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM_IR GetHydratedStaticXE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_PACKAGE1_FUNCCONVERTDECIMALTOVARCHAR_IM_IR();
		// Input parameters
		retObj.VAR_INPUT = (-134886834);
