...
{
	public XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM_IR GetHydratedStaticXE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_PACKAGE1_OPEN_ONE_CURSOR_IM_IR();
		// Input parameters
		retObj.N_EMPNO = (-804910294);
