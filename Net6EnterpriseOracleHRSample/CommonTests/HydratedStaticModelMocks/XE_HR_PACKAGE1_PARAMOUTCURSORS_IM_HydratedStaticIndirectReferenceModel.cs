...
{
	public XE_HR_PACKAGE1_PARAMOUTCURSORS_IM_IR GetHydratedStaticXE_HR_PACKAGE1_PARAMOUTCURSORS_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_PACKAGE1_PARAMOUTCURSORS_IM_IR();
		// Input parameters
		retObj.VAR_INPUT = (-1985915299);
		retObj.VAR_DATE_INPUT = DateTime.Parse("4/8/2022 12:00:00 AM");
