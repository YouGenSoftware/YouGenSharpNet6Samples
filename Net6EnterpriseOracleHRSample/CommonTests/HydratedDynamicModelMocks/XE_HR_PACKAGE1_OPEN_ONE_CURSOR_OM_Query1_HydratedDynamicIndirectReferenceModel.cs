...
{
	protected Filler<XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR> _XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_Filler = new Filler<XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR>();
	protected FillerSetup? _XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_FillerSetup;
	public FillerSetup GetXE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_FillerSetup(Boolean onlyFillExplicitlyNamedProperties)
	{
		if (_XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_FillerSetup != null)
			return _XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_FillerSetup;
		_XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_FillerSetup = _XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_Filler.Setup(onlyFillExplicitlyNamedProperties)
	...
	public XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR GetHydratedDynamicXE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR(Boolean onlyFillExplicitlyNamedProperties = true)
	{
		return GetHydratedDynamicIEnumerableOfXE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR(1, onlyFillExplicitlyNamedProperties).First();
	}
	public IEnumerable<XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR> GetHydratedDynamicIEnumerableOfXE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR(Int32 numberToCreate, 
		Boolean onlyFillExplicitlyNamedProperties = true)
	{
		_XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_Filler.Setup(GetXE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_FillerSetup(onlyFillExplicitlyNamedProperties));
		var retObjects =  _XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR_Filler.Create(numberToCreate);
		FillInnerTypes(retObjects);
		return retObjects;
	}
	private void FillInnerTypes(IEnumerable<XE_HR_PACKAGE1_OPEN_ONE_CURSOR_OM_Query1_IR> irModels)
	{
