...
[TestClass()]
public class XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected IXE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_SignalRWebsocketClient? _signalRWebsocketClient;
    ...
    public override async Task Init()
    {
        ...
        _signalRWebsocketClient = new XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_SignalRWebsocketClient(_hubUriBase + "/XE_HR_PACKAGE1_OPEN_TWO_CURSORS_StoredProcedure_Hub");
	...
	{
		// When
		var retData = await _signalRWebsocketClient!.Call_XE_HR_PACKAGE1_OPEN_TWO_CURSORS();
		// Then
