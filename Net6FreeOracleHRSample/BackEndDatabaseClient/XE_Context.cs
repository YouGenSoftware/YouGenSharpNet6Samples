...
public partial class XE_HR_Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
		modelBuilder.Entity<XE_HR_COUNTRIES>(entity =>
		{
			...
			entity.HasComment("country table. Contains 25 rows. References with locations table.");
		...
		modelBuilder.Entity<XE_HR_DEPARTMENTS>(entity =>
		{
			...
			entity.HasComment("Departments table that shows details of departments where employees work. Contains 27 rows; references with locations, employees, and job_history tables.");
		...
		modelBuilder.Entity<XE_HR_EMPLOYEES>(entity =>
		{
			...
			entity.HasComment("employees table. Contains 107 rows. References with departments, jobs, job_history tables. Contains a self reference.");
		...
		modelBuilder.Entity<XE_HR_JOBS>(entity =>
		{
			...
			entity.HasComment("jobs table with job titles and salary ranges. Contains 19 rows.References with employees and job_history table.");
