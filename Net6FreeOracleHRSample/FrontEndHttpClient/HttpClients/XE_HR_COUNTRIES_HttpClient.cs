...
public class XE_HR_COUNTRIES_HttpClient : HttpClientBase, IXE_HR_COUNTRIES_HttpClient
{
	...
	public async Task<IEnumerable<XE_HR_COUNTRIES>?> GetAll()
	{
		...
		return content == String.Empty ? null : JsonConvert.DeserializeObject<IEnumerable<XE_HR_COUNTRIES>?>(content, _jsonSerializationSettings);
	}
	...
	public async Task<XE_HR_COUNTRIES?> Create(XE_HR_COUNTRIES input)
	{
		...
		result.EnsureSuccessStatusCode();
		var content = await result.Content.ReadAsStringAsync();
		return content == String.Empty ? null : JsonConvert.DeserializeObject<XE_HR_COUNTRIES?>(content, _jsonSerializationSettings);
	}
	public async Task UpdateByEncodedPrimaryKey(String? encodedPrimaryKey, XE_HR_COUNTRIES updateModel)
	{
	...
	public async Task UpdateByCOUNTRY_ID(String cOUNTRY_ID, XE_HR_COUNTRIES input)
	{
