...
public class XE_HR_JOBS_HttpClient : HttpClientBase, IXE_HR_JOBS_HttpClient
{
	...
	public async Task<IEnumerable<XE_HR_JOBS>?> GetAll()
	{
		...
		return content == String.Empty ? null : JsonConvert.DeserializeObject<IEnumerable<XE_HR_JOBS>?>(content, _jsonSerializationSettings);
	}
	...
	public async Task<XE_HR_JOBS?> Create(XE_HR_JOBS input)
	{
		...
		result.EnsureSuccessStatusCode();
		var content = await result.Content.ReadAsStringAsync();
		return content == String.Empty ? null : JsonConvert.DeserializeObject<XE_HR_JOBS?>(content, _jsonSerializationSettings);
	}
	public async Task UpdateByEncodedPrimaryKey(String? encodedPrimaryKey, XE_HR_JOBS updateModel)
	{
	...
	public async Task UpdateByJOB_ID(String jOB_ID, XE_HR_JOBS input)
	{
