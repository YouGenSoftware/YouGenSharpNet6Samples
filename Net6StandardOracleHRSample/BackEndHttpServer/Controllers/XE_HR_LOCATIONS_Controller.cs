...
public class XE_HR_LOCATIONS_Controller : ControllerBase
{
	...
	public async Task<XE_HR_LOCATIONS?> Create([FromBody]XE_HR_LOCATIONS input)
	{
	...
	public async Task UpdateByCITY(String cITY, [FromBody]XE_HR_LOCATIONS input)
	{
	...
	public async Task UpdateByCOUNTRY_ID(String? cOUNTRY_ID, [FromBody]XE_HR_LOCATIONS input)
	{
	...
	public async Task UpdateByLOCATION_ID(Int32 lOCATION_ID, [FromBody]XE_HR_LOCATIONS input)
	{
	...
	public async Task UpdateBySTATE_PROVINCE(String? sTATE_PROVINCE, [FromBody]XE_HR_LOCATIONS input)
	{
