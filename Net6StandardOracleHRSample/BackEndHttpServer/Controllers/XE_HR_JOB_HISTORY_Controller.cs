...
public class XE_HR_JOB_HISTORY_Controller : ControllerBase
{
	...
	{
		return await _requestHandler.HandleGetByEMPLOYEE_IDAndSTART_DATE(eMPLOYEE_ID, sTART_DATE);
	}
	/// <summary>
	/// Get record of JOB_HISTORY table by indexed selector(s)
	/// </summary>
	...
	public async Task<XE_HR_JOB_HISTORY?> Create([FromBody]XE_HR_JOB_HISTORY input)
	{
	...
	public async Task UpdateByEMPLOYEE_IDAndSTART_DATE(Int32 eMPLOYEE_ID, DateTime sTART_DATE, [FromBody]XE_HR_JOB_HISTORY input)
	{
		await _requestHandler.HandleUpdateByEMPLOYEE_IDAndSTART_DATE(eMPLOYEE_ID, sTART_DATE, input);
	}
	/// <summary>
	/// Update record of JOB_HISTORY table by indexed selector(s)
	/// Note: Any foreign key data referenced by or referencing these records should not be included in the body payload
	...
	public async Task UpdateByDEPARTMENT_ID(Int32? dEPARTMENT_ID, [FromBody]XE_HR_JOB_HISTORY input)
	{
	...
	public async Task UpdateByEMPLOYEE_ID(Int32 eMPLOYEE_ID, [FromBody]XE_HR_JOB_HISTORY input)
	{
	...
	public async Task UpdateByJOB_ID(String jOB_ID, [FromBody]XE_HR_JOB_HISTORY input)
	{
	...
	{
		await _requestHandler.HandleDeleteByEMPLOYEE_IDAndSTART_DATE(eMPLOYEE_ID, sTART_DATE);
	}
	/// <summary>
	/// Delete record of JOB_HISTORY table by indexed selector(s)
	/// </summary>
