...
[TestClass()]
public class Northwind_dbo_Alphabetical_list_of_products_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected INorthwind_dbo_Alphabetical_list_of_products_SignalRWebsocketClient? _signalRWebsocketClient;
	[TestInitialize()]
    public override async Task Init()
    {
        await base.Init();
        _signalRWebsocketClient = new Northwind_dbo_Alphabetical_list_of_products_SignalRWebsocketClient(_hubUriBase + "/Northwind_dbo_Alphabetical_list_of_products_Hub");
