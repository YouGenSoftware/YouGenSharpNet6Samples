...
[TestClass()]
public class Northwind_dbo_Summary_of_Sales_by_Year_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected INorthwind_dbo_Summary_of_Sales_by_Year_SignalRWebsocketClient? _signalRWebsocketClient;
	[TestInitialize()]
    public override async Task Init()
    {
        await base.Init();
        _signalRWebsocketClient = new Northwind_dbo_Summary_of_Sales_by_Year_SignalRWebsocketClient(_hubUriBase + "/Northwind_dbo_Summary_of_Sales_by_Year_Hub");
