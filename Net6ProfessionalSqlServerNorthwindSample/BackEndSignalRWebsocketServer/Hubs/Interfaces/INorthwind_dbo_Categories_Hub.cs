...
public interface INorthwind_dbo_Categories_Hub
{
	Task<IEnumerable<Northwind_dbo_Categories_IR>?> HandleGeAll();
	...
	Task<Northwind_dbo_Categories_IR?> HandleCreate(Northwind_dbo_Categories_IR input);
