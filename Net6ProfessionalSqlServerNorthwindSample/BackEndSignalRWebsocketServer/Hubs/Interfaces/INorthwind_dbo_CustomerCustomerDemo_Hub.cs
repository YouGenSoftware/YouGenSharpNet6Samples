...
public interface INorthwind_dbo_CustomerCustomerDemo_Hub
{
	Task<IEnumerable<Northwind_dbo_CustomerCustomerDemo_IR>?> HandleGeAll();
	...
	Task<Northwind_dbo_CustomerCustomerDemo_IR?> HandleCreate(Northwind_dbo_CustomerCustomerDemo_IR input);
