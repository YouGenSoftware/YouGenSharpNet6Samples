...
public interface INorthwind_dbo_Region_Hub
{
	Task<IEnumerable<Northwind_dbo_Region_IR>?> HandleGeAll();
	Task<IEnumerable<Northwind_dbo_Region_IR>?> GetByRegionID(String? regionID_IR);
	Task<Northwind_dbo_Region_IR?> HandleCreate(Northwind_dbo_Region_IR input);
