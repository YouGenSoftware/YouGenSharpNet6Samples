...
public interface INorthwind_dbo_CustomerDemographics_Hub
{
	Task<IEnumerable<Northwind_dbo_CustomerDemographics_IR>?> HandleGeAll();
	Task<IEnumerable<Northwind_dbo_CustomerDemographics_IR>?> GetByCustomerTypeID(String customerTypeID);
	Task<Northwind_dbo_CustomerDemographics_IR?> HandleCreate(Northwind_dbo_CustomerDemographics_IR input);
