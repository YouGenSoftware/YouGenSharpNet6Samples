...
public interface INorthwind_dbo_Shippers_Hub
{
	Task<IEnumerable<Northwind_dbo_Shippers_IR>?> HandleGeAll();
	Task<IEnumerable<Northwind_dbo_Shippers_IR>?> GetByShipperID(String? shipperID_IR);
	Task<Northwind_dbo_Shippers_IR?> HandleCreate(Northwind_dbo_Shippers_IR input);
