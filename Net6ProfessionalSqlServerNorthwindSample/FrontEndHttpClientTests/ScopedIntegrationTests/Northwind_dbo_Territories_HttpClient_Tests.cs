...
[TestClass()]
public class Northwind_dbo_Territories_HttpClient_Tests : HttpClientTestBase
{
	protected INorthwind_dbo_Territories_HttpClient? _specificHttpClient;
    ...
    public override void Init()
    {
        ...
        _specificHttpClient = new Northwind_dbo_Territories_HttpClient(_httpClient!);
    }
	[TestMethod()]
	...
	public async Task GetByTerritoryIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		// When
		var retData = await _specificHttpClient!.GetByTerritoryID(input.TerritoryID ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByTerritoryIDDynamicTest()
	{
		...
		// When
		await _specificHttpClient!.UpdateByTerritoryID(input.TerritoryID ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByTerritoryIDStaticTest()
	{
		...
		var input = _staticIRModels!.GetHydratedStaticNorthwind_dbo_Territories_IR();
		// When
		await _specificHttpClient!.UpdateByTerritoryID(input.TerritoryID ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByTerritoryIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		// When
		await _specificHttpClient!.DeleteByTerritoryID(input.TerritoryID ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
