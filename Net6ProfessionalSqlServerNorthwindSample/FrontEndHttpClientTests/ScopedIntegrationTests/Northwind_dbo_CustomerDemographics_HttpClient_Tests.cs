...
[TestClass()]
public class Northwind_dbo_CustomerDemographics_HttpClient_Tests : HttpClientTestBase
{
	protected INorthwind_dbo_CustomerDemographics_HttpClient? _specificHttpClient;
    ...
    public override void Init()
    {
        ...
        _specificHttpClient = new Northwind_dbo_CustomerDemographics_HttpClient(_httpClient!);
    }
	[TestMethod()]
	...
	public async Task GetByCustomerTypeIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_CustomerDemographics_IR();
		// When
		var retData = await _specificHttpClient!.GetByCustomerTypeID(input.CustomerTypeID ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByCustomerTypeIDDynamicTest()
	{
		...
		// When
		await _specificHttpClient!.UpdateByCustomerTypeID(input.CustomerTypeID ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByCustomerTypeIDStaticTest()
	{
		...
		var input = _staticIRModels!.GetHydratedStaticNorthwind_dbo_CustomerDemographics_IR();
		// When
		await _specificHttpClient!.UpdateByCustomerTypeID(input.CustomerTypeID ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByCustomerTypeIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_CustomerDemographics_IR();
		// When
		await _specificHttpClient!.DeleteByCustomerTypeID(input.CustomerTypeID ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
