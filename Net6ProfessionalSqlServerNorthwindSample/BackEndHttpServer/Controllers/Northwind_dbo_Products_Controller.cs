...
public class Northwind_dbo_Products_Controller : ControllerBase
{
	...
	public async Task<Northwind_dbo_Products_IR?> Create([FromBody]Northwind_dbo_Products_IR input)
	{
	...
	public async Task UpdateByCategoryID(String? categoryID_IR, [FromBody]Northwind_dbo_Products_IR input)
	{
	...
	public async Task UpdateByProductID(String? productID_IR, [FromBody]Northwind_dbo_Products_IR input)
	{
	...
	public async Task UpdateByProductName(String productName, [FromBody]Northwind_dbo_Products_IR input)
	{
	...
	public async Task UpdateBySupplierID(String? supplierID_IR, [FromBody]Northwind_dbo_Products_IR input)
	{
