...
{
	public Northwind_dbo_Summary_of_Sales_by_Quarter_IR GetHydratedStaticNorthwind_dbo_Summary_of_Sales_by_Quarter_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_Summary_of_Sales_by_Quarter_IR();
		retObj.ShippedDate = DateTime.Parse("8/12/2007 12:00:00 AM");
		retObj.OrderID_IR = (fillPrimaryKey ? _encryptionDecryptionService!.EncInt32(Convert.ToInt32(1)) : String.Empty);
		retObj.Subtotal = (0.8422572728311541M);
		return retObj;
	}
}
