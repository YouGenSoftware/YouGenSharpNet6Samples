...
{
	public Northwind_dbo_Current_Product_List_IR GetHydratedStaticNorthwind_dbo_Current_Product_List_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_Current_Product_List_IR();
		retObj.ProductID_IR = (fillPrimaryKey ? _encryptionDecryptionService!.EncInt32(Convert.ToInt32(1)) : String.Empty);
		retObj.ProductName = "cvBusYLJZhGUX6P7Gq dAqC0jk 8 s5mm3xiiBx6";
		return retObj;
	}
}
