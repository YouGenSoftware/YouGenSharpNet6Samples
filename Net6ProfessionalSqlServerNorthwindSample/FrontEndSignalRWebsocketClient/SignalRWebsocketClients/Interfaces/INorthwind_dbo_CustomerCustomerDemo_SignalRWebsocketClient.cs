...
public interface INorthwind_dbo_CustomerCustomerDemo_SignalRWebsocketClient
{
	Task<IEnumerable<Northwind_dbo_CustomerCustomerDemo_IR>?> GetAll();
	Task<IEnumerable<Northwind_dbo_CustomerCustomerDemo_IR>?> GetByBestMatchedQueryPattern(Northwind_dbo_CustomerCustomerDemo_IR input);
