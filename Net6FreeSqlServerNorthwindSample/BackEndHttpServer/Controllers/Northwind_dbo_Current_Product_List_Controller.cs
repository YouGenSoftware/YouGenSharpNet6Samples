...
[RequireHttps]
public class Northwind_dbo_Current_Product_List_Controller : ControllerBase
{
	private readonly INorthwind_dbo_Current_Product_List_RequestHandler _requestHandler;
	public Northwind_dbo_Current_Product_List_Controller(INorthwind_dbo_Current_Product_List_RequestHandler requestHandler)
	{
		_requestHandler = requestHandler;
	}
	/// <summary>
	/// Get All records of Current_Product_List view
	/// </summary>
	[HttpGet, Route("Northwind_dbo_Current_Product_List/GetAll")]
	public async Task<IEnumerable<Northwind_dbo_Current_Product_List>?> GetAll()
	{
