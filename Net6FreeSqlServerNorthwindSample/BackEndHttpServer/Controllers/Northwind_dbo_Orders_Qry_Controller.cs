...
[RequireHttps]
public class Northwind_dbo_Orders_Qry_Controller : ControllerBase
{
	private readonly INorthwind_dbo_Orders_Qry_RequestHandler _requestHandler;
	public Northwind_dbo_Orders_Qry_Controller(INorthwind_dbo_Orders_Qry_RequestHandler requestHandler)
	{
		_requestHandler = requestHandler;
	}
	/// <summary>
	/// Get All records of Orders_Qry view
	/// </summary>
	[HttpGet, Route("Northwind_dbo_Orders_Qry/GetAll")]
	public async Task<IEnumerable<Northwind_dbo_Orders_Qry>?> GetAll()
	{
