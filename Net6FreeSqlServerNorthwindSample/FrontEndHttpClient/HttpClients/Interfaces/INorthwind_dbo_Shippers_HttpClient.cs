...
{
	Task<IEnumerable<Northwind_dbo_Shippers>?> GetAll();
	Task<IEnumerable<Northwind_dbo_Shippers>?> GetByShipperID(Int32 shipperID);
	Task<Northwind_dbo_Shippers?> Create(Northwind_dbo_Shippers input);
	Task UpdateByShipperID(Int32 shipperID, Northwind_dbo_Shippers input);
	Task DeleteByShipperID(Int32 shipperID);
}
