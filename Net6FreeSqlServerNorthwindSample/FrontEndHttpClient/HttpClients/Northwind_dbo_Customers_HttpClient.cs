...
public class Northwind_dbo_Customers_HttpClient : HttpClientBase, INorthwind_dbo_Customers_HttpClient
{
	...
	public async Task<IEnumerable<Northwind_dbo_Customers>?> GetAll()
	{
		var result = await _httpClient.GetAsync(_httpClient.BaseAddress!.ToString() + "Northwind_dbo_Customers/GetAll");
		result.EnsureSuccessStatusCode();
		var content = await result.Content.ReadAsStringAsync();
		return content == String.Empty ? null : JsonConvert.DeserializeObject<IEnumerable<Northwind_dbo_Customers>?>(content, _jsonSerializationSettings);
	}
	public async Task<IEnumerable<Northwind_dbo_Customers>?> GetByCity(String? city)
	{
	...
	public async Task<IEnumerable<Northwind_dbo_Customers>?> GetByCompanyName(String companyName)
	{
	...
	public async Task<IEnumerable<Northwind_dbo_Customers>?> GetByCustomerID(String customerID)
	{
	...
	public async Task<IEnumerable<Northwind_dbo_Customers>?> GetByPostalCode(String? postalCode)
	{
	...
	public async Task<IEnumerable<Northwind_dbo_Customers>?> GetByRegion(String? region)
	{
	...
	public async Task<Northwind_dbo_Customers?> Create(Northwind_dbo_Customers input)
	{
		...
		result.EnsureSuccessStatusCode();
		var content = await result.Content.ReadAsStringAsync();
		return content == String.Empty ? null : JsonConvert.DeserializeObject<Northwind_dbo_Customers?>(content, _jsonSerializationSettings);
	}
	public async Task UpdateByEncodedPrimaryKey(String? encodedPrimaryKey, Northwind_dbo_Customers updateModel)
	{
	...
	public async Task UpdateByCity(String? city, Northwind_dbo_Customers input)
	{
	...
	public async Task UpdateByCompanyName(String companyName, Northwind_dbo_Customers input)
	{
	...
	public async Task UpdateByCustomerID(String customerID, Northwind_dbo_Customers input)
	{
	...
	public async Task UpdateByPostalCode(String? postalCode, Northwind_dbo_Customers input)
	{
	...
	public async Task UpdateByRegion(String? region, Northwind_dbo_Customers input)
	{
