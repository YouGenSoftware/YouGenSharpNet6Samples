...
public class Northwind_dbo_Summary_of_Sales_by_Quarter_HttpClient : HttpClientBase, INorthwind_dbo_Summary_of_Sales_by_Quarter_HttpClient
{
	...
	public async Task<IEnumerable<Northwind_dbo_Summary_of_Sales_by_Quarter>?> GetAll()
	{
		...
		return content == String.Empty ? null : JsonConvert.DeserializeObject<IEnumerable<Northwind_dbo_Summary_of_Sales_by_Quarter>?>(content, _jsonSerializationSettings);
	}
}
