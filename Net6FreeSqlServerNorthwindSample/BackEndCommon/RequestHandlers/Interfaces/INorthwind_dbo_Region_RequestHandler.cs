...
{
	//Main Handlers
	Task<IEnumerable<Northwind_dbo_Region>?> HandleGetAll();
	Task<IEnumerable<Northwind_dbo_Region>?> HandleGetByRegionID(Int32 regionID);
	Task<Northwind_dbo_Region?> HandleCreate(Northwind_dbo_Region entity);
	Task HandleUpdateByRegionID(Int32 regionID, Northwind_dbo_Region entity);
	Task HandleDeleteByRegionID(Int32 regionID);
}
