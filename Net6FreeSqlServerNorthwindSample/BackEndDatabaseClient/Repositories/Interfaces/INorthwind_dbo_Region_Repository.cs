...
public interface INorthwind_dbo_Region_Repository : IGenericTableRepository<Northwind_dbo_Region>
{
	Task<IEnumerable<Northwind_dbo_Region>?> GetByRegionID(Int32 regionID_);
	Task UpdateByRegionID(Int32 regionID_, Northwind_dbo_Region entity);
	Task DeleteByRegionID(Int32 regionID_);
}
