...
[TestClass()]
public class XE_HR_REGIONS_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected IXE_HR_REGIONS_SignalRWebsocketClient? _signalRWebsocketClient;
    ...
    public override async Task Init()
    {
        ...
        _signalRWebsocketClient = new XE_HR_REGIONS_SignalRWebsocketClient(_hubUriBase + "/XE_HR_REGIONS_Hub");
	...
	public async Task GetByREGION_IDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		// When
		var retData = await _signalRWebsocketClient!.GetByREGION_ID(input.REGION_ID_IR ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByREGION_IDDynamicTest()
	{
		...
		// When
		await _signalRWebsocketClient!.UpdateByREGION_ID(input.REGION_ID_IR ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByREGION_IDStaticTest()
	{
		...
		var input = _staticIRModels!.GetHydratedStaticXE_HR_REGIONS_IR();
		// When
		await _signalRWebsocketClient!.UpdateByREGION_ID(input.REGION_ID_IR ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByREGION_IDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicXE_HR_REGIONS_IR();
		// When
		await _signalRWebsocketClient!.DeleteByREGION_ID(input.REGION_ID_IR ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
