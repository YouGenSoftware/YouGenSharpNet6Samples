...
{
	public XE_HR_REGIONS_IR GetHydratedStaticXE_HR_REGIONS_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new XE_HR_REGIONS_IR();
		retObj.REGION_ID_IR = (fillPrimaryKey ? _encryptionDecryptionService!.EncInt32(Convert.ToInt32(1)) : String.Empty);
		retObj.REGION_NAME = "BeEWPjivMektsSEMsRYZW45Um";
		return retObj;
	}
}
