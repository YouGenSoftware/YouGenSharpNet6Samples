...
public class Northwind_dbo_Categories_HttpClient : HttpClientBase, INorthwind_dbo_Categories_HttpClient
{
	...
	public async Task<IEnumerable<Northwind_dbo_Categories>?> GetAll()
	{
		...
		return content == String.Empty ? null : JsonConvert.DeserializeObject<IEnumerable<Northwind_dbo_Categories>?>(content, _jsonSerializationSettings);
	}
	...
	{
		var uri = GetUriForParamsCategoryID("Northwind_dbo_Categories/GetByCategoryID", categoryID);
		var result = await _httpClient.GetAsync(uri);
		result.EnsureSuccessStatusCode();
		var content = await result.Content.ReadAsStringAsync();
		return content == String.Empty ? null : JsonConvert.DeserializeObject<IEnumerable<Northwind_dbo_Categories>?>(content, _jsonSerializationSettings);
	}
	public async Task<Northwind_dbo_Categories?> Create(Northwind_dbo_Categories input)
	{
		...
		result.EnsureSuccessStatusCode();
		var content = await result.Content.ReadAsStringAsync();
		return content == String.Empty ? null : JsonConvert.DeserializeObject<Northwind_dbo_Categories?>(content, _jsonSerializationSettings);
	}
	public async Task UpdateByEncodedPrimaryKey(String? encodedPrimaryKey, Northwind_dbo_Categories updateModel)
	{
		if (encodedPrimaryKey == null || updateModel == null) return;
		var inputSplits = encodedPrimaryKey.Split((Char)27);
		await UpdateByCategoryID(Convert.ToInt32(inputSplits[0]), updateModel);
	}
	public async Task UpdateByCategoryName(String categoryName, Northwind_dbo_Categories input)
	{
	...
	public async Task UpdateByCategoryID(Int32 categoryID, Northwind_dbo_Categories input)
	{
		var uri = GetUriForParamsCategoryID("Northwind_dbo_Categories/UpdateByCategoryID", categoryID);
		var serializedInput = JsonConvert.SerializeObject(input, _jsonSerializationSettings);
		var result = await _httpClient.PutAsync(uri, new StringContent(serializedInput, Encoding.UTF8, "application/json"));
		result.EnsureSuccessStatusCode();
	}
	public async Task DeleteByEncodedPrimaryKey(String? input)
	{
		...
		await DeleteByCategoryID(Convert.ToInt32(inputSplits[0]));
	}
	...
	{
		var uri = GetUriForParamsCategoryID("Northwind_dbo_Categories/DeleteByCategoryID", categoryID);
		var result = await _httpClient.DeleteAsync(uri);
		result.EnsureSuccessStatusCode();
	}
