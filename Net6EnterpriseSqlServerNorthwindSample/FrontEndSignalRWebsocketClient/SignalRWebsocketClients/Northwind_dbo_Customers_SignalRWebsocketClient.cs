...
public class Northwind_dbo_Customers_SignalRWebsocketClient : SignalRWebsocketClientBase, INorthwind_dbo_Customers_SignalRWebsocketClient, IAsyncDisposable
{
	public Northwind_dbo_Customers_SignalRWebsocketClient(String hubUrl) : base(hubUrl)
    {
    }
	...
	{
		return await _hubConnection.InvokeAsync<IEnumerable<Northwind_dbo_Customers_IR>?>("GetAll");
	}
	public async Task<IEnumerable<Northwind_dbo_Customers_IR>?> GetByCity(String? city)
	{
		return await _hubConnection.InvokeAsync<IEnumerable<Northwind_dbo_Customers_IR>?>("GetByCity", city);
	}
	public async Task<IEnumerable<Northwind_dbo_Customers_IR>?> GetByCompanyName(String companyName)
	{
		return await _hubConnection.InvokeAsync<IEnumerable<Northwind_dbo_Customers_IR>?>("GetByCompanyName", companyName);
	}
	public async Task<IEnumerable<Northwind_dbo_Customers_IR>?> GetByCustomerID(String customerID)
	{
		return await _hubConnection.InvokeAsync<IEnumerable<Northwind_dbo_Customers_IR>?>("GetByCustomerID", customerID);
	}
	public async Task<IEnumerable<Northwind_dbo_Customers_IR>?> GetByPostalCode(String? postalCode)
	{
		return await _hubConnection.InvokeAsync<IEnumerable<Northwind_dbo_Customers_IR>?>("GetByPostalCode", postalCode);
	}
	public async Task<IEnumerable<Northwind_dbo_Customers_IR>?> GetByRegion(String? region)
	{
		return await _hubConnection.InvokeAsync<IEnumerable<Northwind_dbo_Customers_IR>?>("GetByRegion", region);
	}
	public async Task<Northwind_dbo_Customers_IR?> Create(Northwind_dbo_Customers_IR input)
	{
		return await _hubConnection.InvokeAsync<Northwind_dbo_Customers_IR?>("Create", input);
	}
	...
	{
		await _hubConnection.InvokeAsync("UpdateByRegion", region, input);
	}
	...
	{
		await _hubConnection.InvokeAsync("DeleteByRegion", region);
	}
