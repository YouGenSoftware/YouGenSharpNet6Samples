...
[TestClass()]
public class Northwind_dbo_Territories_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected INorthwind_dbo_Territories_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/Northwind_dbo_Territories_Service");
        _serviceClient = new Northwind_dbo_Territories_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	...
	{
		// Given
		var input = (Northwind_dbo_Territories_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		// When
	...
	{
		// Given
		var input = (Northwind_dbo_Territories_IR)(object)_staticIRModels!.GetHydratedStaticNorthwind_dbo_Territories_IR();
		// When
		var retData = await _serviceClient!.CreateAsync(input);
		// Then
		Assert.IsTrue(retData != null);
	...
	public async Task GetByTerritoryIDDynamicTest()
	{
		...
		var input = (Northwind_dbo_Territories_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		// When
		var retData = await _serviceClient!.GetByTerritoryIDAsync(input.TerritoryID ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByTerritoryIDDynamicTest()
	{
		// Given
		var input = (Northwind_dbo_Territories_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		var input2 = (Northwind_dbo_Territories_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		// When
		await _serviceClient!.UpdateByTerritoryIDAsync(input.TerritoryID ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByTerritoryIDStaticTest()
	{
		...
		var input = (Northwind_dbo_Territories_IR)(object)_staticIRModels!.GetHydratedStaticNorthwind_dbo_Territories_IR();
		// When
		await _serviceClient!.UpdateByTerritoryIDAsync(input.TerritoryID ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByTerritoryIDDynamicTest()
	{
		...
		var input = (Northwind_dbo_Territories_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Territories_IR();
		// When
		await _serviceClient!.DeleteByTerritoryIDAsync(input.TerritoryID ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
