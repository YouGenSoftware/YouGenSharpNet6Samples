...
[TestClass()]
public class Northwind_dbo_Region_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected INorthwind_dbo_Region_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/Northwind_dbo_Region_Service");
        _serviceClient = new Northwind_dbo_Region_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	...
	{
		// Given
		var input = (Northwind_dbo_Region_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Region_IR();
		// When
	...
	{
		// Given
		var input = (Northwind_dbo_Region_IR)(object)_staticIRModels!.GetHydratedStaticNorthwind_dbo_Region_IR();
		// When
		var retData = await _serviceClient!.CreateAsync(input);
		// Then
		Assert.IsTrue(retData != null);
	...
	public async Task GetByRegionIDDynamicTest()
	{
		...
		var input = (Northwind_dbo_Region_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Region_IR();
		// When
		var retData = await _serviceClient!.GetByRegionIDAsync(input.RegionID_IR ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByRegionIDDynamicTest()
	{
		// Given
		var input = (Northwind_dbo_Region_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Region_IR();
		var input2 = (Northwind_dbo_Region_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Region_IR();
		// When
		await _serviceClient!.UpdateByRegionIDAsync(input.RegionID_IR ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByRegionIDStaticTest()
	{
		...
		var input = (Northwind_dbo_Region_IR)(object)_staticIRModels!.GetHydratedStaticNorthwind_dbo_Region_IR();
		// When
		await _serviceClient!.UpdateByRegionIDAsync(input.RegionID_IR ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByRegionIDDynamicTest()
	{
		...
		var input = (Northwind_dbo_Region_IR)(object)_dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Region_IR();
		// When
		await _serviceClient!.DeleteByRegionIDAsync(input.RegionID_IR ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
