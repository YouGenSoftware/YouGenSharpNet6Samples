...
[TestClass()]
public class Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_WCFClient_Tests : CoreWCFServiceClientTestBase
{    
	protected INorthwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Service? _serviceClient;    
    ...
    public override void Init()
    {
        ...
        _endpointAddress = new EndpointAddress(_baseAddress! + "/Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Service");
        _serviceClient = new Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_ServiceClient(_binding!, _endpointAddress!);
    }
	[TestMethod()]
	public async Task StaticCall_Northwind_dbo_Ten_Most_Expensive_Products_Test()
	{
		// When
		var retData = await _serviceClient!.Call_Northwind_dbo_Ten_Most_Expensive_ProductsAsync();
		// Then
