...
[TestClass()]
public class Northwind_dbo_Categories_HttpClient_Tests : HttpClientTestBase
{
	protected INorthwind_dbo_Categories_HttpClient? _specificHttpClient;
    ...
    public override void Init()
    {
        ...
        _specificHttpClient = new Northwind_dbo_Categories_HttpClient(_httpClient!);
    }
	[TestMethod()]
	...
	public async Task GetByCategoryNameDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Categories_IR();
		// When
		var retData = await _specificHttpClient!.GetByCategoryName(input.CategoryName ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByCategoryNameDynamicTest()
	{
		...
		// When
		await _specificHttpClient!.UpdateByCategoryName(input.CategoryName ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByCategoryNameStaticTest()
	{
		...
		var input = _staticIRModels!.GetHydratedStaticNorthwind_dbo_Categories_IR();
		// When
		await _specificHttpClient!.UpdateByCategoryName(input.CategoryName ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	...
	public async Task DeleteByCategoryNameDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Categories_IR();
		// When
		await _specificHttpClient!.DeleteByCategoryName(input.CategoryName ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
