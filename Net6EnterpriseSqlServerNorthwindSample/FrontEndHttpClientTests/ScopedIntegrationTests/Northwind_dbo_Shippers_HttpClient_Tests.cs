...
[TestClass()]
public class Northwind_dbo_Shippers_HttpClient_Tests : HttpClientTestBase
{
	protected INorthwind_dbo_Shippers_HttpClient? _specificHttpClient;
    ...
    public override void Init()
    {
        ...
        _specificHttpClient = new Northwind_dbo_Shippers_HttpClient(_httpClient!);
    }
	[TestMethod()]
	...
	public async Task GetByShipperIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Shippers_IR();
		// When
		var retData = await _specificHttpClient!.GetByShipperID(input.ShipperID_IR ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByShipperIDDynamicTest()
	{
		...
		// When
		await _specificHttpClient!.UpdateByShipperID(input.ShipperID_IR ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByShipperIDStaticTest()
	{
		...
		var input = _staticIRModels!.GetHydratedStaticNorthwind_dbo_Shippers_IR();
		// When
		await _specificHttpClient!.UpdateByShipperID(input.ShipperID_IR ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByShipperIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_Shippers_IR();
		// When
		await _specificHttpClient!.DeleteByShipperID(input.ShipperID_IR ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
