...
/// </summary>
public class Northwind_dbo_Products_IR
{
	public Northwind_dbo_Products_IR() 
	{
	} 
	public Northwind_dbo_Products_IR(
	...
	)
	{
		...
		PrimaryKeyEncryptedForUpdateDeleteIdentification = productID_IR_;
	}
	[JsonConstructor]
	public Northwind_dbo_Products_IR(
		String? ProductID_IR,
	...
	public virtual Northwind_dbo_Categories_IR? FK_Products_Categories_Ref_IR { get; set; }
	public virtual Northwind_dbo_Suppliers_IR? FK_Products_Suppliers_Ref_IR { get; set; }
	/// <summary>
	/// Entities that reference this entity by foreign key
	/// </summary>
	/// <example>null</example>
	public virtual ICollection<Northwind_dbo_Order_Details_IR>?FK_Order_Details_Products_RefBy_IR { get; set; } = new HashSet<Northwind_dbo_Order_Details_IR>();
	/// <summary>
	/// Foreign key entity
	/// </summary>
	/// <example>null</example>
