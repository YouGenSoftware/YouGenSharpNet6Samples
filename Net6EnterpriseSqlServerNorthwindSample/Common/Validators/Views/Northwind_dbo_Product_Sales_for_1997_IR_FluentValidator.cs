...
public class Northwind_dbo_Product_Sales_for_1997_IR_FluentValidator : AbstractValidator<Northwind_dbo_Product_Sales_for_1997_IR>, IFluentValidator_Base
{
    public Northwind_dbo_Product_Sales_for_1997_IR_FluentValidator()
    {
    ...
    {
        var result = await ValidateAsync(ValidationContext<Northwind_dbo_Product_Sales_for_1997_IR>.CreateWithOptions((Northwind_dbo_Product_Sales_for_1997_IR)model, x => x.IncludeProperties(propertyName)));
        if (result.IsValid)
    ...
    public async Task ValidateModelAndThrow(Object model)
    {
        try
        {
            await this.ValidateAndThrowAsync((Northwind_dbo_Product_Sales_for_1997_IR)model);
        }
        catch (Exception ex)
        {
#if DEBUG
