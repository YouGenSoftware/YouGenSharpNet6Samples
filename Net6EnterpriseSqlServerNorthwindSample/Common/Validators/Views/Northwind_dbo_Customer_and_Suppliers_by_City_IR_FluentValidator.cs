...
public class Northwind_dbo_Customer_and_Suppliers_by_City_IR_FluentValidator : AbstractValidator<Northwind_dbo_Customer_and_Suppliers_by_City_IR>, IFluentValidator_Base
{
    public Northwind_dbo_Customer_and_Suppliers_by_City_IR_FluentValidator()
    {
			// RuleFor(x => x.City)
				// .NotEmpty();
    ...
    {
        var result = await ValidateAsync(ValidationContext<Northwind_dbo_Customer_and_Suppliers_by_City_IR>.CreateWithOptions((Northwind_dbo_Customer_and_Suppliers_by_City_IR)model, x => x.IncludeProperties(propertyName)));
        if (result.IsValid)
    ...
    public async Task ValidateModelAndThrow(Object model)
    {
        try
        {
            await this.ValidateAndThrowAsync((Northwind_dbo_Customer_and_Suppliers_by_City_IR)model);
        }
        catch (Exception ex)
        {
#if DEBUG
