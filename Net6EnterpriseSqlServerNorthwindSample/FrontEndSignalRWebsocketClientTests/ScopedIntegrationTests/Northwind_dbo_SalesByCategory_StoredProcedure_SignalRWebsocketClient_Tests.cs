...
[TestClass()]
public class Northwind_dbo_SalesByCategory_StoredProcedure_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected INorthwind_dbo_SalesByCategory_StoredProcedure_SignalRWebsocketClient? _signalRWebsocketClient;
    ...
    public override async Task Init()
    {
        ...
        _signalRWebsocketClient = new Northwind_dbo_SalesByCategory_StoredProcedure_SignalRWebsocketClient(_hubUriBase + "/Northwind_dbo_SalesByCategory_StoredProcedure_Hub");
	...
	public async Task StaticCall_Northwind_dbo_SalesByCategory_Test()
	{
		...
		// When
		var retData = await _signalRWebsocketClient!.Call_Northwind_dbo_SalesByCategory(input);
		// Then
