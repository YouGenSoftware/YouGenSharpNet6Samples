...
[TestClass()]
public class Northwind_dbo_Orders_Qry_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected INorthwind_dbo_Orders_Qry_SignalRWebsocketClient? _signalRWebsocketClient;
	[TestInitialize()]
    public override async Task Init()
    {
        await base.Init();
        _signalRWebsocketClient = new Northwind_dbo_Orders_Qry_SignalRWebsocketClient(_hubUriBase + "/Northwind_dbo_Orders_Qry_Hub");
