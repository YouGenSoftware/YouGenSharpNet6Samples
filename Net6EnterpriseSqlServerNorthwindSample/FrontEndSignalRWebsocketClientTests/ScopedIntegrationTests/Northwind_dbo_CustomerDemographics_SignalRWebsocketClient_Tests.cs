...
[TestClass()]
public class Northwind_dbo_CustomerDemographics_SignalRWebsocketClient_Tests : SignalRWebsocketClientTestBase
{   
	protected INorthwind_dbo_CustomerDemographics_SignalRWebsocketClient? _signalRWebsocketClient;
    ...
    public override async Task Init()
    {
        ...
        _signalRWebsocketClient = new Northwind_dbo_CustomerDemographics_SignalRWebsocketClient(_hubUriBase + "/Northwind_dbo_CustomerDemographics_Hub");
	...
	public async Task GetByCustomerTypeIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_CustomerDemographics_IR();
		// When
		var retData = await _signalRWebsocketClient!.GetByCustomerTypeID(input.CustomerTypeID ?? String.Empty);
		// Then
		Assert.IsTrue(retData != null && retData.Any());
		// TODO: Add test cases
	}
	...
	public async Task UpdateByCustomerTypeIDDynamicTest()
	{
		...
		// When
		await _signalRWebsocketClient!.UpdateByCustomerTypeID(input.CustomerTypeID ?? String.Empty, input2);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task UpdateByCustomerTypeIDStaticTest()
	{
		...
		var input = _staticIRModels!.GetHydratedStaticNorthwind_dbo_CustomerDemographics_IR();
		// When
		await _signalRWebsocketClient!.UpdateByCustomerTypeID(input.CustomerTypeID ?? String.Empty, input);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
	public async Task DeleteByCustomerTypeIDDynamicTest()
	{
		...
		var input = _dynamicIRModels!.GetHydratedDynamicNorthwind_dbo_CustomerDemographics_IR();
		// When
		await _signalRWebsocketClient!.DeleteByCustomerTypeID(input.CustomerTypeID ?? String.Empty);
		// Then
		// TODO: Add test cases
	}
	[TestMethod()]
