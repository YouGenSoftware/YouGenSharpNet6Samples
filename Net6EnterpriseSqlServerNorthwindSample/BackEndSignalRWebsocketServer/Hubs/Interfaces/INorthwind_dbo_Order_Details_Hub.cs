...
public interface INorthwind_dbo_Order_Details_Hub
{
	Task<IEnumerable<Northwind_dbo_Order_Details_IR>?> HandleGeAll();
	...
	Task<Northwind_dbo_Order_Details_IR?> HandleCreate(Northwind_dbo_Order_Details_IR input);
