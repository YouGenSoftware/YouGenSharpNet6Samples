...
public interface INorthwind_dbo_EmployeeTerritories_Hub
{
	Task<IEnumerable<Northwind_dbo_EmployeeTerritories_IR>?> HandleGeAll();
	...
	Task<Northwind_dbo_EmployeeTerritories_IR?> HandleCreate(Northwind_dbo_EmployeeTerritories_IR input);
