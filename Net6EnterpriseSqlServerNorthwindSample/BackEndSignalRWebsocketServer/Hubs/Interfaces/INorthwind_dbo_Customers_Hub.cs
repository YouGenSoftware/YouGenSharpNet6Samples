...
public interface INorthwind_dbo_Customers_Hub
{
	Task<IEnumerable<Northwind_dbo_Customers_IR>?> HandleGeAll();
	...
	Task<Northwind_dbo_Customers_IR?> HandleCreate(Northwind_dbo_Customers_IR input);
