...
public interface INorthwind_dbo_Suppliers_Hub
{
	Task<IEnumerable<Northwind_dbo_Suppliers_IR>?> HandleGeAll();
	...
	Task<Northwind_dbo_Suppliers_IR?> HandleCreate(Northwind_dbo_Suppliers_IR input);
