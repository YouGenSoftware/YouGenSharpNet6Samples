...
public class Northwind_dbo_Invoices_Hub : Hub<INorthwind_dbo_Invoices_Hub>
{
	private readonly INorthwind_dbo_Invoices_RequestHandler _requestHandler;
	public Northwind_dbo_Invoices_Hub(INorthwind_dbo_Invoices_RequestHandler requestHandler)
	{
