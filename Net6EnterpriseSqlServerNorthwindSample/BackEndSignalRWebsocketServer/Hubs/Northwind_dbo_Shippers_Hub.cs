...
public class Northwind_dbo_Shippers_Hub : Hub<INorthwind_dbo_Shippers_Hub>
{
	private readonly INorthwind_dbo_Shippers_RequestHandler _requestHandler;
	public Northwind_dbo_Shippers_Hub(INorthwind_dbo_Shippers_RequestHandler requestHandler)
	{
