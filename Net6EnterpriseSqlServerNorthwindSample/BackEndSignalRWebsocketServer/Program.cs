...
public class Program
{
    public static void Main()
    {
		...
		app.MapHub<Northwind_dbo_CustOrderHist_StoredProcedure_Hub>("Northwind_dbo_CustOrderHist_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_CustOrdersDetail_StoredProcedure_Hub>("Northwind_dbo_CustOrdersDetail_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_CustOrdersOrders_StoredProcedure_Hub>("Northwind_dbo_CustOrdersOrders_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_Employee_Sales_by_Country_StoredProcedure_Hub>("Northwind_dbo_Employee_Sales_by_Country_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_ProductsAndCategories_StoredProcedure_Hub>("Northwind_dbo_ProductsAndCategories_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_Sales_by_Year_StoredProcedure_Hub>("Northwind_dbo_Sales_by_Year_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_SalesByCategory_StoredProcedure_Hub>("Northwind_dbo_SalesByCategory_StoredProcedure_Hub");
		app.MapHub<Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Hub>("Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Hub");
