...
{
	protected Filler<Northwind_dbo_Orders_Qry> _Northwind_dbo_Orders_Qry_Filler = new Filler<Northwind_dbo_Orders_Qry>();
	protected FillerSetup? _Northwind_dbo_Orders_Qry_FillerSetup;
	public FillerSetup GetNorthwind_dbo_Orders_Qry_FillerSetup(Boolean onlyFillExplicitlyNamedProperties)
	{
		if (_Northwind_dbo_Orders_Qry_FillerSetup != null)
			return _Northwind_dbo_Orders_Qry_FillerSetup;
		_Northwind_dbo_Orders_Qry_FillerSetup = _Northwind_dbo_Orders_Qry_Filler.Setup(onlyFillExplicitlyNamedProperties)
		...
		.OnProperty(x => x.EmployeeID).Use(() => Random.Shared.Next(Int32.MinValue, Int32.MaxValue))
	...
	public Northwind_dbo_Orders_Qry GetHydratedDynamicNorthwind_dbo_Orders_Qry(Boolean onlyFillExplicitlyNamedProperties = true)
	{
		return GetHydratedDynamicIEnumerableOfNorthwind_dbo_Orders_Qry(1, onlyFillExplicitlyNamedProperties).First();
	}
	public IEnumerable<Northwind_dbo_Orders_Qry> GetHydratedDynamicIEnumerableOfNorthwind_dbo_Orders_Qry(Int32 numberToCreate, 
		Boolean onlyFillExplicitlyNamedProperties = true)
	{
		_Northwind_dbo_Orders_Qry_Filler.Setup(GetNorthwind_dbo_Orders_Qry_FillerSetup(onlyFillExplicitlyNamedProperties));
		var retObjects = _Northwind_dbo_Orders_Qry_Filler.Create(numberToCreate);
		return retObjects;
	}
}
