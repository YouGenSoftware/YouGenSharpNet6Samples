...
{
	protected Filler<Northwind_dbo_Customers> _Northwind_dbo_Customers_Filler = new Filler<Northwind_dbo_Customers>();
	protected FillerSetup? _Northwind_dbo_Customers_FillerSetup;
	public FillerSetup GetNorthwind_dbo_Customers_FillerSetup(Boolean onlyFillExplicitlyNamedProperties, 
		Boolean fillPrimaryKey = false)
	{
		if (_Northwind_dbo_Customers_FillerSetup != null)
			return _Northwind_dbo_Customers_FillerSetup;
		_Northwind_dbo_Customers_FillerSetup = _Northwind_dbo_Customers_Filler.Setup(onlyFillExplicitlyNamedProperties)
		...
		.OnProperty(x => x.FK_CustomerCustomerDemo_Customers_RefBy).IgnoreIt()
		.OnProperty(x => x.FK_Orders_Customers_RefBy).IgnoreIt()
		.Result;
		return _Northwind_dbo_Customers_FillerSetup;
	}
	public Northwind_dbo_Customers GetHydratedDynamicNorthwind_dbo_Customers(Boolean onlyFillExplicitlyNamedProperties = true, 
		Boolean fillPrimaryKey = false,	
		Boolean fillInnerForeignKeys = false, 
		Boolean fillInnerPrimaryKeyReferencedBy = false)
	{
		return GetHydratedDynamicIEnumerableOfNorthwind_dbo_Customers(1,
			onlyFillExplicitlyNamedProperties, 
			fillPrimaryKey, 
			fillInnerForeignKeys, 
			fillInnerPrimaryKeyReferencedBy).First();
	}
	public IEnumerable<Northwind_dbo_Customers> GetHydratedDynamicIEnumerableOfNorthwind_dbo_Customers(Int32 numberToCreate, 
		Boolean onlyFillExplicitlyNamedProperties = true, 
		Boolean fillPrimaryKey = false, 
		Boolean fillInnerForeignKeys = false, 
		Boolean fillInnerPrimaryKeyReferencedBy = false)
	{
		_Northwind_dbo_Customers_Filler.Setup(GetNorthwind_dbo_Customers_FillerSetup(onlyFillExplicitlyNamedProperties, fillPrimaryKey));
		var retObjects = _Northwind_dbo_Customers_Filler.Create(numberToCreate);
	...
	private void FillInnerForeignKeys(IEnumerable<Northwind_dbo_Customers> entities)
	{
		foreach (var entity in entities)
		{
		}
	}
	private void FillInnerPrimaryKeyReferencedBy(IEnumerable<Northwind_dbo_Customers> entities)
	{
		foreach (var entity in entities)
		{
			// entity.FK_CustomerCustomerDemo_Customers_RefBy!.Add(GetHydratedDynamicNorthwind_dbo_CustomerCustomerDemo());
			// entity.FK_Orders_Customers_RefBy!.Add(GetHydratedDynamicNorthwind_dbo_Orders());
		}
	}
}
