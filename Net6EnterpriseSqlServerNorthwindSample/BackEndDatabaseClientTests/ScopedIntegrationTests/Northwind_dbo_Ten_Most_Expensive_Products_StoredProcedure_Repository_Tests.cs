...
[TestClass()]
public class Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Repository_Tests : ScopedIntegrationStoredProcedureRepositoryTestBase
{
    private Mock<ILogger<Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Repository>>? _logger;
	private INorthwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Repository? _repository;
    ...
    {
        base.Init();
        _logger = new Mock<ILogger<Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Repository>>();		
        _repository = new Northwind_dbo_Ten_Most_Expensive_Products_StoredProcedure_Repository(_logger!.Object, _dbConnection!);
