...
{
	public Northwind_dbo_SalesByCategory_IM_IR GetHydratedStaticNorthwind_dbo_SalesByCategory_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_SalesByCategory_IM_IR();
		retObj.CategoryName = "zNuz1jo0Y4RRAgE";
		retObj.OrdYear = "rZL5";
		return retObj;
	}
}
