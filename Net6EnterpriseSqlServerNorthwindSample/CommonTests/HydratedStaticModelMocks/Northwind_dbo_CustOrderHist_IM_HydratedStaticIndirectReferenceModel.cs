...
{
	public Northwind_dbo_CustOrderHist_IM_IR GetHydratedStaticNorthwind_dbo_CustOrderHist_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_CustOrderHist_IM_IR();
		retObj.CustomerID = "IGJxm";
		return retObj;
	}
}
