...
{
	public Northwind_dbo_Order_Details_Extended_IR GetHydratedStaticNorthwind_dbo_Order_Details_Extended_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_Order_Details_Extended_IR();
		...
		retObj.ProductName = "0WTcEfzg43gcGftTCgm5Nby3O5NYTHTUU7hWe9n ";
		retObj.UnitPrice = (0.07500322720503605M);
		retObj.Quantity = (10682);
		retObj.Discount = (0.035734832F);
		retObj.ExtendedPrice = (0.21524844083515726M);
		return retObj;
	}
}
