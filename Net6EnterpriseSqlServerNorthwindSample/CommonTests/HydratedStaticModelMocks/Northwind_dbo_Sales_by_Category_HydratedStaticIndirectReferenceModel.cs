...
{
	public Northwind_dbo_Sales_by_Category_IR GetHydratedStaticNorthwind_dbo_Sales_by_Category_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_Sales_by_Category_IR();
		retObj.CategoryID_IR = (fillPrimaryKey ? _encryptionDecryptionService!.EncInt32(Convert.ToInt32(1)) : String.Empty);
		retObj.CategoryName = "AQlLMmdschlgRmT";
		retObj.ProductName = "fkxL68bEoLnKUO5kiEMz740aXT7UROhJps1nQAEp";
		retObj.ProductSales = (0.33368969569581686M);
		return retObj;
	}
}
