...
{
	public Northwind_dbo_CustOrdersOrders_IM_IR GetHydratedStaticNorthwind_dbo_CustOrdersOrders_IM_IR(Boolean fillPrimaryKey = false)
	{
		var retObj = new Northwind_dbo_CustOrdersOrders_IM_IR();
		retObj.CustomerID = "3wyK3";
		return retObj;
	}
}
