...
public class Northwind_dbo_Shippers_Controller : ControllerBase
{
	...
	public async Task<Northwind_dbo_Shippers_IR?> Create([FromBody]Northwind_dbo_Shippers_IR input)
	{
	...
	public async Task UpdateByShipperID(String? shipperID_IR, [FromBody]Northwind_dbo_Shippers_IR input)
	{
