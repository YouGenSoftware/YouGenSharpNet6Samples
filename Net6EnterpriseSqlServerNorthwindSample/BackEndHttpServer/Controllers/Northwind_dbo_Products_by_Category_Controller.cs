...
[RequireHttps]
public class Northwind_dbo_Products_by_Category_Controller : ControllerBase
{
	private readonly INorthwind_dbo_Products_by_Category_RequestHandler _requestHandler;
	public Northwind_dbo_Products_by_Category_Controller(INorthwind_dbo_Products_by_Category_RequestHandler requestHandler)
	{
		_requestHandler = requestHandler;
	}
	/// <summary>
	/// Get All records of Products_by_Category view
	/// </summary>
	[HttpGet, Route("Northwind_dbo_Products_by_Category/GetAll")]
