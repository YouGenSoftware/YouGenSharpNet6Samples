...
public class Northwind_dbo_Categories_Controller : ControllerBase
{
	...
	public async Task<Northwind_dbo_Categories_IR?> Create([FromBody]Northwind_dbo_Categories_IR input)
	{
	...
	public async Task UpdateByCategoryName(String categoryName, [FromBody]Northwind_dbo_Categories_IR input)
	{
	...
	public async Task UpdateByCategoryID(String? categoryID_IR, [FromBody]Northwind_dbo_Categories_IR input)
	{
