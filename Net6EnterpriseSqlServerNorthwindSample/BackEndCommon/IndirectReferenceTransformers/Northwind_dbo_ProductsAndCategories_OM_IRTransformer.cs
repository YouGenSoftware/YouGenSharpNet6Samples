...
{
	public Northwind_dbo_ProductsAndCategories_OM_IR ToIndirectModel(Northwind_dbo_ProductsAndCategories_OM input)
	{
		var retData = new Northwind_dbo_ProductsAndCategories_OM_IR(
		);
	...
	public Northwind_dbo_ProductsAndCategories_OM ToEntity(Northwind_dbo_ProductsAndCategories_OM_IR input)
	{
