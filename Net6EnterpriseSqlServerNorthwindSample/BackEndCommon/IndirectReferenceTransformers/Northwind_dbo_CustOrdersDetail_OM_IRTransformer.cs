...
{
	public Northwind_dbo_CustOrdersDetail_OM_IR ToIndirectModel(Northwind_dbo_CustOrdersDetail_OM input)
	{
		var retData = new Northwind_dbo_CustOrdersDetail_OM_IR(
	...
	public Northwind_dbo_CustOrdersDetail_OM ToEntity(Northwind_dbo_CustOrdersDetail_OM_IR input)
	{
		var retData = new Northwind_dbo_CustOrdersDetail_OM(		
